...
func CRC(requestCommand []byte) []byte {
	//fmt.Printf("lanuch")

	//m_data := []byte{0x01, 0x03, 0x00, 0x00, 0x00, 0x32}

	checksum := checkSum(requestCommand)
	...
	resultData := append(requestCommand, int16buf.Bytes()...)
